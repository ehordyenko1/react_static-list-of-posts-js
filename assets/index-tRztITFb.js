...
aut aut aut maxime quia temporibus ut omnis`}],zc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Nc=({user:e})=>j.jsxs("p",{children:[" Posted by  ",j.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name})]}),Pc=({comment:e})=>{e.name,`${e.email}`,e.email,e.body},Lc=({comments:e})=>(e.length<=0,j.jsx("div",{className:"CommentList",children:e.map(t=>j.jsx(Pc,{comment:t},t.id))})),Tc=({post:e})=>{e.title,e.user,e.body,e.comment},Mc=({posts:e})=>j.jsx("div",{className:"PostList",children:e.map(t=>j.jsx(Tc,{post:t},t.id))}),Rc=Ec.map(e=>{const t=zc.find(({id:n})=>n===e.userId),i=Cc.filter(({postId:n})=>n===e.id);return{...e,user:t,comments:i}}),Dc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Mc,{posts:Rc})]});em(document.getElementById("root")).render(j.jsx(Dc,{}));
